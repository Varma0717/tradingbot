    ...
    def get_bot(cls, user_id, bot_type="stock"):
        ...
        with cls._lock:
            ...
            if key not in cls._instances:
                ...
                logger.info(f"Created new {bot_type} bot instance for user {user_id}")
    ...
    def restore_active_bots(cls):
        ...
        with current_app.app_context():
            try:
                ...
                active_bots = TradingBotStatus.query.filter_by(is_running=True).all()
                ...
                for bot_status in active_bots:
                    ...
                    if (
                        ...
                        bot = cls.get_bot(bot_status.user_id, bot_status.bot_type)
                        ...
                        if bot_status.strategies:
                            try:
                                if bot_status.bot_type == "crypto":
                                    ...
                                    bot.start_trading(bot_status.strategies)
                ...
                logger.error(f"Error restoring active bots: {e}")
